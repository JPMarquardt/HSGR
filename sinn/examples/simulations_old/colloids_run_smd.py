...
def set_up_simulation(parameters: RunParameters, types: npt.NDArray[str],
    ...
    cv0module = torch.jit.script(CVModule('Alignn-k17-L4-spg22-n7-combiner0.pkl', types_ml))
    cv1module = torch.jit.script(CVModule('Alignn-k17-L4-spg22-n7-combiner1.pkl', types_ml))
...
if __name__ == '__main__':
    ...
    pkl.dump(np.array(metad_object.getFreeEnergy()), open('fes.p', 'wb'))
